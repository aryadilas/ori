...
<x-filament-panels::layout.base :livewire="$livewire">
    ...
    <div class="flex flex-col items-center min-h-screen bg-[linear-gradient(144.67deg,_rgba(0,_199,_190,_0.052)_85.89%,_rgba(0,_97,_93,_0.52)_107.96%)] fi-simple-layout">
        ...
        <div
            class="flex flex-col items-center justify-center flex-grow w-full fi-simple-main-ctn"
        >
            <div @class([
                '',
            ...
            <main
                @class([
                    'fi-simple-main my-10 w-full bg-white px-6 py-12 shadow-sm ring-1 ring-gray-950/5 dark:bg-gray-900 dark:ring-white/10 sm:rounded-xl sm:px-12',
                    match ($maxWidth ??= (filament()->getSimplePageMaxContentWidth() ?? MaxWidth::Large)) {
                        MaxWidth::ExtraSmall, 'xs' => 'max-w-xs',
                        MaxWidth::Small, 'sm' => 'max-w-sm',
                        MaxWidth::Medium, 'md' => 'max-w-md',
